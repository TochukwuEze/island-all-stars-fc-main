...
import MembersImage from "../../../public/images/members/memberImage2.webp";
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#001429] via-[#001429]/80 to-primaryColor/30" />
            ...
            {[
              {
                ...
                desc: "Access to Lagos' most exclusive football network.",
              },
              {
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-6 mb-8 space-y-4">
            ...
            <div className="pt-2 space-y-2.5 text-xs text-gray-600 font-semibold border-t border-gray-200/50">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>
                  Lagos Business School KM 22, Lekki-Epe Expressway, Ajah,
                  Lagos, Nigeria
                </span>
              </div>
            </div>
