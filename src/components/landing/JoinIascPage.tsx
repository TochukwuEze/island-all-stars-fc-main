      ...
      <FadeIn direction="right" className="hidden lg:flex lg:w-1/2 bg-[#001429] relative overflow-hidden flex-col justify-center p-20 text-white">
        ...
        <div className="relative z-10">
          <Link href="/" className="inline-block mb-12">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center">
                <span className="text-primaryColor font-black text-2xl">IASC</span>
              </div>
              <span className="text-xl font-black uppercase tracking-tighter">Island Allstars Sports Club</span>
            </div>
          </Link>
          ...
          <div className="space-y-8">
            {[
              { icon: <Shield className="w-6 h-6 text-primaryColor" />, title: "Elite Community", desc: "Access to Lagos' most exclusive sports network." },
        ...
        <FadeIn direction="left" className="max-w-md w-full mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Self-registration is currently disabled for Island Allstars Sports Club. To maintain the exclusivity of our network, accounts are strictly managed and created by the Club Secretariat.
            </p>
          </div>

          {/* Action Card */}
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-6 mb-8 space-y-4">
            <h3 className="font-bold uppercase text-xs tracking-wider text-[#001429]">How to Join IASC</h3>
