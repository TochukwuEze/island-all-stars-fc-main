  ...
  return (
    <section className="bg-[#f9f9f9] text-black py-24 px-6 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        <h2 className={`text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight mb-12 ${sofiaSansCondensed.className}`}>
          End of Year League
        </h2>
        ...
        <div className="w-full bg-white shadow-sm border border-gray-100">
          <div className="bg-black text-white px-6 py-4 border-t-4 border-[#FF4D00]">
            <h3 className="text-xs font-bold uppercase tracking-widest">League Standings</h3>
          </div>
              ...
              <tbody>
                {teams.map((team, idx) => (
                  <tr key={idx} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 text-left font-medium text-gray-400">{team.pos}</td>
          ...
          <div className="px-6 py-4 text-right">
            <Link href="/stats" className="text-[#FF4D00] text-xs font-semibold hover:underline">
              View full table
            </Link>
          </div>
        </div>
        ...
        {/* Button */}
        <div className="mt-12">
          <Link href="/stats" className="bg-[#FF4D00] text-white px-8 py-4 text-xs font-bold uppercase tracking-widest hover:bg-[#e64500] transition-colors inline-block">
            View Report
          </Link>
        </div>
      </div>
