...
export const galleryItems: GalleryItem[] = [
  ...
  // -- IASC Lekki 8 Aside Tournament 2016 --------------------------------------
  {
    ...
    description: "Arise TV was recognized for their support and contribution to the success of the Island All Stars Sports Club. The award was presented at the club's End of Year Party in 2024.",
    category: "Dec 16, 2024",
    year: 2024,
  },
  // (Additional items from the original file would follow here...)
];
